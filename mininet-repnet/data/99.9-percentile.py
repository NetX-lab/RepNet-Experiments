...
for i in range(1, 9):
    ...
    mat[0, i-1] = getpt(single, 99.9) 
    mat[1, i-1] = getpt(repflow, 99.9)
    mat[2, i-1] = getpt(repsyn, 99.9)
...
plt.ylabel('99.9th percentile FCT')

plt.tight_layout(rect=(0,0,1,1))
plt.grid()
plt.savefig("mininet-999.pdf", format='pdf')
plt.show()
